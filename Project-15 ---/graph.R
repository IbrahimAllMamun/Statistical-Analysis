...
# ----------------------------------------------------------
# Figures 6 & 7 - NEWS / NLPR by outcome, one panel per day
# ----------------------------------------------------------
# These mirror the two markers carried by Tables 2-4. NLR was replaced by
# NEWS there, so it is replaced here too and survives only as a
...
p_news <- density_plot(dat, "news", "NEWS score")
ggsave("Graph/Fig6_NEWS_density_by_outcome.png", p_news,
...
message("Saved -> Graph/Fig6_NEWS_density_by_outcome.png")
